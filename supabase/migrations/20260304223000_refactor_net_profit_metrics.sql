-- Align financial metrics with split-based organizer net and GMV from payments.
-- This prevents overestimating organizer net when split is percentual and/or Asaas
-- applies operational deductions before effective transfer.
