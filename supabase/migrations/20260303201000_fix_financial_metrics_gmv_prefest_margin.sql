...
-- Organizer revenue = ticket net amount (unit_price * quantity - discount)
-- Platform fee = 10% of organizer revenue
-- Customer total (GMV) = organizer revenue + platform fee
    ...
    daily AS (
      ...
      FROM (
        SELECT
          ...
          SUM(pf.customer_total)::numeric AS total
