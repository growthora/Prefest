-- Function to validate ticket manually by code (partial ID)
...
BEGIN
  ...
  -- 3. Verify permission (Must be organizer of the event)
  ...
  VALUES (v_participant.id, v_event_id, p_validated_by, NOW());
