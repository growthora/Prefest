...
export function EventDetailsEditorModal({
  ...
  const saveTicket = async (ticket: TicketTypeDB) => {
    ...
    if (Number.isNaN(price) || price < 0) {
      toast({ title: 'Preço invalido', description: 'Informe um preco valido.', variant: 'destructive' });
      return;
    }
                              ...
                              <>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                  ...
                                  <div>
                                    ...
                                    />
                                    <p className="text-xs text-muted-foreground mt-1">
                                      Mínimo permitido: {ticket.quantity_sold}
                                    </p>
                                  </div>
                                  <div>
              ...
              <TabsContent value="datas_status" className="mt-0 space-y-4">
                ...
                <div className="flex items-center justify-between rounded-lg border p-3">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Controle rápido para ativar ou pausar vendas.</p>
                  </div>
                  <Switch
